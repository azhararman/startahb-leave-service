package com.startahb.crm.leave.filter;





import com.startahb.crm.leave.exception.JwtTokenException;
import com.startahb.crm.leave.exception.JwtTokenExpiredException;
import com.startahb.crm.leave.exception.JwtTokenParseException;
...
//                }
                ...
                if (isTokenValid && isNoAuthentication) {
                    ...
                    UsernamePasswordAuthenticationToken authentication = new UsernamePasswordAuthenticationToken(
                            username, token, jwtTokenUtil.getAuthoritiesFromToken(token));  //Collection<? extends GrantedAuthority> authorities
